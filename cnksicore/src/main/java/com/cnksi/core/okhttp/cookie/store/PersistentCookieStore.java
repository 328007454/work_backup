package com.cnksi.core.okhttp.cookie.store;
...
public class PersistentCookieStore implements CookieStore {
    ...
    protected void add(HttpUrl uri, Cookie cookie) {
        ...
        if (!cookie.persistent()) {
            ...
            if (cookies.containsKey(uri.toString())) cookies.get(uri.host()).remove(name);
        }
    ...
    public List<Cookie> get(HttpUrl uri) {
        ...
        if (cookies.containsKey(uri.host())) ret.addAll(cookies.get(uri.host()).values());
        return ret;
    }
