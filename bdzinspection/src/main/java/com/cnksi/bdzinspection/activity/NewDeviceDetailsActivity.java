    ...
    private void initUI() {
        ...
        devicedetailsBinding.deviceStandardLv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (isParticularInspection((null == specialMenu) ? "" : specialMenu.standardsOrigin) || (Config.InspectionType.special_xideng.equals(currentInspectionType))) {
...
//                showImageDetails(currentActivity, Config.RESULT_PICTURES_FOLDER + placedDevice.pic, true);
        ...
        mFixedThreadPoolExecutor.execute(() -> {
            ...
            if (placedDevice != null && placedDevice.isHasPhoto())
                runOnUiThread(() -> {
                    ...
                    imgList = StringUtils.stringsToList(placedDevice.pic, ",");
                    refreshDevicePic();
                });
        });
    }
    ...
    private void setDeviceImage() {
        ...
        devicedetailsBinding.ivDeviceImage.setImageBitmap(BitmapUtil.getImageThumbnail(Device.getPic(picPath), maxWidth, maxHeight));
    }
    ...
    private void showStandardSource(final DbModel standard) {
        ...
        String source = StringUtils.nullTo(standard.getString(Standards.ORIGIN), getString(R.string.xs_no_source_str));
            ...
            sourceBinding.btnMark.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (oper == null) {
                        ...
                        mark = DeviceStandardsOper.createMark(mCurrentDevice, staid, PreferencesUtils.getString(currentActivity, Config.CURRENT_LOGIN_USER, ""));
                    } else {
                        mark = oper;
                        tips = "是否撤销不适用标注?";
                        mark.dlt = "1";
        ...
        } else sourceBinding.btnMark.setVisibility(View.GONE);
                    ...
                    case 3:
                        ...
                        try {
                            ...
                            if (null != typeImageList && !typeImageList.isEmpty()) {
                                ...
                                CToast.showLong(NewDeviceDetailsActivity.this, "暂无图库可供选择");
                            }
            ...
            switch (requestCode) {
                ...
                case PHOTO_SIGN_IMAGE:
                    ...
                    mFixedThreadPoolExecutor.execute(() -> {
                        ...
                        String tips = PreferencesUtils.getString(currentActivity, Config.CURRENT_LOGIN_USER, "");
    ...
    class GestureHandler {
        ...
        public boolean left() {
            ...
            if (model == null) {
                CToast.showShort(currentActivity, "没有找到上一个设备！");
                return false;
            }
        ...
        public boolean right() {
            ...
            if (model == null) {
                CToast.showShort(currentActivity, "没有找到下一个设备！");
                return false;
            }
        ...
        private void jumpDevice(DbModel model, int anim1) {
            ...
            if (devicePartRecylerAdapter != null) devicePartRecylerAdapter.setClickPosition(0);
            initUI();
            initData();
        }
    }
