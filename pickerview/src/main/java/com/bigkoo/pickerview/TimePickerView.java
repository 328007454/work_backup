...
public class TimePickerView extends BasePickerView implements View.OnClickListener {
    ...
    private boolean incancelable;//是否能取消
    ...
    public TimePickerView(Builder builder) {
        ...
        this.incancelable = builder.incancelable;
    ...
    public static class Builder {
        ...
        private boolean incancelable = false;//是否能取消
        ...
        private Integer colors[];//Required
        ...
        public Builder setColors(Integer[] colors) {
            this.colors = colors;
            return this;
        }
        ...
        public Builder setInsideCancelable(boolean incancelable) {
            this.incancelable = incancelable;
            return this;
        }
    ...
    private void initView(Context context) {
        ...
        setInSideCancelable(incancelable);
        ...
        if (colors != null && colors.length != 0)
            wheelTime = new WheelTime(timePickerView, type, gravity, Size_Content, colors);
        else
