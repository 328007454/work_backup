...
public class WheelTime {
    ...
    private int yearSize = 18;
    private int monthSize = 18;
    private int daySize = 18;
    private int hourSize = 18;
    private int minute = 18;
    private int second = 18;
    ...
    public WheelTime(LinearLayout view, boolean[] type, int gravity, int textSize, Integer[] colors) {
        this.view = view;
        this.type = type;
        this.gravity = gravity;
        this.textSize = textSize;
...
//                maxItem = endD;
    ...
    private void setDividerColor() {
        if (colors != null && colors.length ==6) {
            wv_year.setDividerColor(colors[0]);
            wv_month.setDividerColor(colors[1]);
            wv_day.setDividerColor(colors[2]);
            wv_hours.setDividerColor(colors[3]);
            wv_mins.setDividerColor(colors[4]);
            wv_seconds.setDividerColor(colors[5]);
        } else {
