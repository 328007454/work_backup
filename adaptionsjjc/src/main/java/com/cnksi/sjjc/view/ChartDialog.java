...
public class ChartDialog {
    ...
    public void showLineChartDialog(Context context, String title, String xLabel, String yLabel, List<String> xValues,List<LineSet> yValues, List<Integer> yColors) {
        dismissDialog();
        dialog = new Dialog(context, R.style.dialog);
        ViewHolder holder = new ViewHolder(context, null, R.layout.dialog_chart, false);
...
//            context.getResources().getColor(yColors.get(index)
    ...
    public void showLineChartDialog(Context context, String title, String xLabel, String yLabel, List<String> xValues, String lineName, List<Float> yValues, int color) {
