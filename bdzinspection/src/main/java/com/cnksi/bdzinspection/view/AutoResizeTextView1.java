 ...
 */
public class AutoResizeTextView1 extends AppCompatTextView {
    ...
    public AutoResizeTextView1(final Context context) {
        this(context, null, android.R.attr.textViewStyle);
    }

    public AutoResizeTextView1(final Context context, final AttributeSet attrs) {
        this(context, attrs, android.R.attr.textViewStyle);
    }

    public AutoResizeTextView1(final Context context, final AttributeSet attrs, final int defStyle) {
        super(context, attrs, defStyle);
        // using the minimal recommended font size
        _minTextSize = TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_PX, AutoUtils.getPercentHeightSizeBigger(44), getResources().getDisplayMetrics());
        _maxTextSize = AutoUtils.getPercentHeightSize((int) getTextSize());
