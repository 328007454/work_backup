...
public class CopyResultService {
    ...
    public List<CopyResult> findAllMaintenanceCopyResult(String reportId, String currentInspectionType, String currentBdzId) throws DbException {
        ...
        copyResults = XunshiApplication.getDbUtils().findAll(Selector.from(CopyResult.class).where(CopyResult.TYPE_KEY, "=", currentInspectionType).and(CopyResult.REPORTID, "=", reportId).and(CopyResult.BDZID, "=", currentBdzId).and(CopyResult.DLT, "=", "0"));
