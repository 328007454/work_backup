...
public class PlaySound {
    ...
    public static void initPlay(Context c) {
        mInstance = new PlaySound(c);
    }
    ...
    private void initSoundMap(Context context) {
        ...
        soundMap.put(R.raw.click_center, mSoundPool.load(context, R.raw.click_center, 1));
    ...
    public static void setPlayNull() {
        if (mInstance != null) {
            mInstance = null;
        }
