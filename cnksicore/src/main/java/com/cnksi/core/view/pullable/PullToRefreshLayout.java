    ...
    public void refreshFinish(int refreshResult) {
        ...
        switch (refreshResult) {
            case SUCCEED:
                ...
                refreshStateImageView.setBackgroundResource(R.mipmap.ic_refresh_succeed);
                break;
            case FAIL:
            default:
                // 刷新失败
                ...
                refreshStateImageView.setBackgroundResource(R.mipmap.ic_refresh_failed);
                break;
        }
        // 刷新结果停留1秒
        new Handler() {
    ...
    public void loadmoreFinish(int refreshResult) {
        ...
        switch (refreshResult) {
            case SUCCEED:
                ...
                loadStateImageView.setBackgroundResource(R.mipmap.ic_refresh_load_succeed);
                break;
            case FAIL:
            default:
                // 加载失败
                ...
                loadStateImageView.setBackgroundResource(R.mipmap.ic_refresh_load_failed);
                break;
        }
        // 刷新结果停留1秒
        new Handler() {
