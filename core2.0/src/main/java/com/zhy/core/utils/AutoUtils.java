...
public class AutoUtils
{
    ...
    {
        auto(view, com.zhy.core.attr.Attrs.TEXTSIZE, AutoAttr.BASE_DEFAULT);
    }

    public static void autoTextSize(View view, int base)
    {
        auto(view, com.zhy.core.attr.Attrs.TEXTSIZE, base);
    }

    public static void autoMargin(View view)
    {
        auto(view, com.zhy.core.attr.Attrs.MARGIN, AutoAttr.BASE_DEFAULT);
    }

    public static void autoMargin(View view, int base)
    {
        auto(view, com.zhy.core.attr.Attrs.MARGIN, base);
    }

    public static void autoPadding(View view)
    {
        auto(view, com.zhy.core.attr.Attrs.PADDING, AutoAttr.BASE_DEFAULT);
    }

    public static void autoPadding(View view, int base)
    {
        auto(view, com.zhy.core.attr.Attrs.PADDING, base);
    }

    public static void autoSize(View view)
    {
        auto(view, com.zhy.core.attr.Attrs.WIDTH | com.zhy.core.attr.Attrs.HEIGHT, AutoAttr.BASE_DEFAULT);
    }

    public static void autoSize(View view, int base)
    {
        auto(view, com.zhy.core.attr.Attrs.WIDTH | com.zhy.core.attr.Attrs.HEIGHT, base);
    }
