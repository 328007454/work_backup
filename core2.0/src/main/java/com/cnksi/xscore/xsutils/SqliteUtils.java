...
public class SqliteUtils {
	 ...
	 * @return
	 */
	public static final Selector getActivedSelector(Class<?> entityType, String activedKey, String activedValue) {
		return Selector.from(entityType).where(activedKey, "=", activedValue);
	}
	 ...
	 * @return
	 */
	public static final Selector getActivedSelector(Class<?> entityType, String activedKey) {
		return Selector.from(entityType).where(activedKey, "=", CoreConfig.ACTIVED);
	}
}
