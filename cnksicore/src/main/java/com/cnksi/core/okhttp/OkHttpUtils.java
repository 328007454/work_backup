package com.cnksi.core.okhttp;

import android.os.Handler;
import android.os.Looper;

import com.cnksi.core.okhttp.builder.GetBuilder;
import com.cnksi.core.okhttp.builder.HeadBuilder;
import com.cnksi.core.okhttp.builder.OtherRequestBuilder;
import com.cnksi.core.okhttp.builder.PostFileBuilder;
import com.cnksi.core.okhttp.builder.PostFormBuilder;
import com.cnksi.core.okhttp.builder.PostStringBuilder;
import com.cnksi.core.okhttp.callback.Callback;
import com.cnksi.core.okhttp.cookie.CookieJarImpl;
import com.cnksi.core.okhttp.cookie.store.CookieStore;
import com.cnksi.core.okhttp.cookie.store.HasCookieStore;
import com.cnksi.core.okhttp.cookie.store.MemoryCookieStore;
import com.cnksi.core.okhttp.https.HttpsUtils;
import com.cnksi.core.okhttp.log.LoggerInterceptor;
import com.cnksi.core.okhttp.request.RequestCall;
import com.cnksi.core.okhttp.utils.Exceptions;
...
public class OkHttpUtils {
    ...
    public OkHttpUtils(OkHttpClient okHttpClient) {
        ...
        //设置默认写入超时（这里无超时）
        setWriteTimeout(1, TimeUnit.DAYS);
