package com.cnksi.xscore.xsview.datepicker;
...
public class WheelMain {
    ...
    public void initDateTimePicker(int year, int month, int day, int h, int m) {
        ...
        // 年
        wv_year = (WheelView) view.findViewById(com.cnksi.xscore.R.id.year);
        ...
        // 日
        wv_day = (WheelView) view.findViewById(com.cnksi.xscore.R.id.day);
        ...
        wv_hours = (WheelView) view.findViewById(com.cnksi.xscore.R.id.hour);
        wv_mins = (WheelView) view.findViewById(com.cnksi.xscore.R.id.min);
        if (hasSelectTime) {
        ...
        int textSize = 0;
        if (hasSelectTime)
//			textSize = mContext.getResources().getDimensionPixelSize(R.dimen.dialog_title_text_size);
            textSize = AutoUtils.getPercentHeightSizeBigger(48);
        else
//			textSize = mContext.getResources().getDimensionPixelSize(R.dimen.tab_strip_text_size);
            textSize = AutoUtils.getPercentHeightSizeBigger(54);
