...
public class DeviceStandardTypeAdapter extends BaseQuickAdapter<DbModel, BaseViewHolder> {
    ...
    public DeviceStandardTypeAdapter(int layoutResId, @Nullable List<DbModel> data) {
    ...
    protected void convert(BaseViewHolder helper, DbModel item) {
        ...
        helper.setText(R.id.txt_standard_type_name, item.getString("name"));
