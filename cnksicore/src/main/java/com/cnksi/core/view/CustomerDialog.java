...
public class CustomerDialog {
    ...
    public static android.app.Dialog showSelectDialog(Activity context, String title, String toast, final DialogClickListener dialogClickListener, int confirmTextId, int canceltextId, boolean isPms) {
    ...
    private static android.app.Dialog ShowDialog(final Activity context, String title, String toast, final DialogClickListener dialogClickListener, final int DialogType, String confirmText, String cancelText, boolean isPms) {
        if (context != null && !context.isDestroyed()) {
            final Dialog mCustomDialog = new android.app.Dialog(context, R.style.DialogStyle);
            mCustomDialog.setCancelable(false);
            View view = LayoutInflater.from(context).inflate(R.layout.dialog_customer, null);
