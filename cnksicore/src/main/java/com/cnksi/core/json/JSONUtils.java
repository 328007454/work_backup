...
import com.cnksi.core.utils.ArrayUtils;
import com.cnksi.core.utils.MapUtils;
...
public class JSONUtils {
	 ...
	 * @return
	 */
	public static String getAttributeByName(String json, String name) {
		try {
	...
	public static String getAttributeByName(JSONObject jsonObj, String name) {
		try {
	...
	public static Object getAttributeObjectificationListByName(String json, String name, Class clazz) {
		...
		if (TextUtils.isEmpty(json)) {
			...
			try {
				...
				if (!TextUtils.isEmpty(name)) {
					String jsonStr = new JSONObject(json).getString(name);
				...
				for (int i = 0; i < len; i++) {
					...
					Object obj = builder.build(jsonArray.getJSONObject(i), clazz);
					list.add(obj);
				}
	...
	public static Object getAttributeObjectificationByName(String json, String name, Class clazz) {
		if (TextUtils.isEmpty(json))
			return null;
		Object result = null;
		try {
			...
			if (TextUtils.isEmpty(name))
				...
				obj = new JSONObject(json).getJSONObject(name);
			ObjectBuilder builder = new ObjectBuilder();
			result = builder.build(obj, clazz);
		} catch (JSONException e) {
	...
	public static ArrayList<String> getStringJsonArray(String json) {
	...
	public static ArrayList<String> getStringJsonArray(String json, String name) {
		ArrayList<String> list = new ArrayList<String>();
		try {
			JSONArray jsonArray = new JSONArray(json);
			int len = jsonArray.length();
			for (int i = 0; i < len; i++) {
				String value = getAttributeByName(jsonArray.getString(i), name);
				list.add(value);
			}
		} catch (JSONException e) {
