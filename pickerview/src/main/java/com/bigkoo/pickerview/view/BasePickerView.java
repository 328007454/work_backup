...
public class BasePickerView {
    ...
    private boolean inSideCancelable;//内部是否可以取消点击
     ...
     * 设置对话框模式是否可以内部空白处部取消
     *
     * @param inSideCancelable
     */
    public void setInSideCancelable(boolean inSideCancelable) {
        this.inSideCancelable = inSideCancelable;
        if (mDialog != null) {
            mDialog.setCancelable(cancelable);
        }
    }
