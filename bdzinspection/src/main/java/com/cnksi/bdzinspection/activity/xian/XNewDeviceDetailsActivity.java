...
import com.cnksi.bdzinspection.activity.SettingCopyTypeActivity;
...
import com.cnksi.bdzinspection.databinding.XActivityDevicedetailsBinding;
import com.cnksi.bdzinspection.databinding.XsDialogStandardSourceBinding;
import com.cnksi.bdzinspection.fragment.xian.DeviceCopyFragment;
import com.cnksi.bdzinspection.fragment.xian.DeviceCurrentDefectFragment;
import com.cnksi.bdzinspection.fragment.xian.DeviceGpsFragment;
import com.cnksi.bdzinspection.fragment.xian.DeviceYJLLFragment;
...
import com.cnksi.common.enmu.DeviceInfo;
 ...
 */
public class XNewDeviceDetailsActivity extends BaseActivity implements DevicePartRecylerAdapter.DevicePartClickListener {
    /**
     * 重点关注标准
     */
    ...
    XActivityDevicedetailsBinding devicedetailsBinding;
    /**
     * 巡检标准来源dialog
     */
    ...
    private String[] topBarTitles = {DeviceInfo.XCQX.value, DeviceInfo.YJLL.value, DeviceInfo.CLSJ.value, DeviceInfo.GPS.value};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        changedStatusColor();
        devicedetailsBinding = DataBindingUtil.setContentView(mActivity, R.layout.x_activity_devicedetails);
        getIntentValue();
        initialUI();
        initialData();
        initOnClick();
...
//        });
    ...
    private void initFragments() {
        DeviceCurrentDefectFragment deviceCurrentDefectFragment = new DeviceCurrentDefectFragment();
        Bundle bundle = new Bundle();
        bundle.putString(Config.CURRENT_DEVICE_ID, currentDeviceId);
        deviceCurrentDefectFragment.setArguments(bundle);
        fragmentList.add(deviceCurrentDefectFragment);
        fragmentList.add(new DeviceYJLLFragment());
        fragmentList.add(new DeviceCopyFragment());
        fragmentList.add(new DeviceGpsFragment());
        FragmentPagerAdapter fragmentPagerAdapter = new FragmentPagerAdapter(getSupportFragmentManager(), fragmentList, Arrays.asList(topBarTitles));
        devicedetailsBinding.viewPager.setAdapter(fragmentPagerAdapter);
        devicedetailsBinding.stWeek.setViewPager(devicedetailsBinding.viewPager);
...
//
    ...
    public void setBtInforSize(boolean btInforSize) {
        if (btInforSize) {
            LinearLayout.LayoutParams llInfor = new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, 156);
            llInfor.weight = 1;
            llInfor.rightMargin = 18;
            devicedetailsBinding.containerBtInfo.setLayoutParams(llInfor);
            devicedetailsBinding.containerBtInfo.setBackgroundResource(R.mipmap.device_info_hover);
            LinearLayout.LayoutParams llContent = new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, 138);
            llContent.weight = 1;
            llContent.leftMargin = 18;
            devicedetailsBinding.containerBtContent.setLayoutParams(llContent);
            devicedetailsBinding.containerBtContent.setBackgroundResource(R.mipmap.tour_content);
            ...
            devicedetailsBinding.contanierBt.setVisibility(View.VISIBLE);
        } else {
            LinearLayout.LayoutParams llInfor = new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, 138);
            llInfor.weight = 1;
            llInfor.rightMargin = 18;
            devicedetailsBinding.containerBtInfo.setLayoutParams(llInfor);
            devicedetailsBinding.containerBtInfo.setBackgroundResource(R.mipmap.device_info);
            LinearLayout.LayoutParams llContent = new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, 156);
            llContent.weight = 1;
            llContent.leftMargin = 18;
            devicedetailsBinding.containerBtContent.setLayoutParams(llContent);
            devicedetailsBinding.containerBtContent.setBackgroundResource(R.mipmap.tour_content_hover);

            devicedetailsBinding.containerDeviceInfo.setVisibility(View.GONE);
            devicedetailsBinding.containerTourInfo.setVisibility(View.VISIBLE);
            devicedetailsBinding.contanierBt.setVisibility(View.GONE);
        }
    ...
    private void showStandardSource(final DbModel standard) {
        ...
        if (isLibStandard) {
            ...
            sourceBinding.btnMark.setOnClickListener(v -> {
                String tips;
